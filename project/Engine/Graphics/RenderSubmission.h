...
// Mesh クラスの前方宣言（循環インクルード回避）
// Mesh の実体は Object3DRenderer::Draw3D() 内でのみ使用する
class Mesh;

/// @brief 描画グループ。ソート順とステート変更の最適化に使用する。
...
/// @brief 3Dオブジェクト 1メッシュ分の Submit データ
/// @details
///   Object3D::Draw() で構築し、Object3DRenderer::Submit() に渡す。
...
/// @brief UIスプライト 1枚分の Submit データ
/// @details
///   Sprite::Draw() で構築し、SpriteRenderer::Submit() に渡す。
