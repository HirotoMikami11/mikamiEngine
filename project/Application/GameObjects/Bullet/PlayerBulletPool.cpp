...
bool PlayerBulletPool::FireBullet(const Vector3& position, const Vector3& velocity) {
...
void PlayerBulletPool::Update(const Matrix4x4& viewProjectionMatrix) {
	// アクティブな弾だけループ
...
std::vector<PlayerBullet*> PlayerBulletPool::GetActiveBullets() {
...
void PlayerBulletPool::ResetAll() {
	// 全弾を非アクティブ化
	for (size_t index : activeIndices_) {
