...
public:
	...
	void Initialize(DirectXCommon* dxCommon, const std::string& presetName = "PlayerBulletHit", const std::string& emitterName = "HitEmitter");
...
private:
	...
	static const size_t kPoolSize_ = 10;
